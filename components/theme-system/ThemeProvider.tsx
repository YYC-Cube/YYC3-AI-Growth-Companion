...
/**
 * 统一主题 Provider（v3.4 主题系统核心）
 *
 * 基于 next-themes：以 <html data-theme="..."> 驱动四套主题
 * （default 暖阳 / cyberpunk 赛博霓虹 / liquid 液态翡翠 / aurora 极光），
 ...
 *  - v3.4 新增 aurora 极光主题（提炼自 YYC3-XY-AI aurora 设计系统）
 */
